...
- Le serveur détermine **lui-même** si le temps annoncé (30s) est réellement dépassé avant d'appliquer la pénalité de défaite — un signal du client prétendant à tort qu'il y a eu expiration est ignoré si le serveur mesure que ce n'est pas le cas, pour ne jamais pénaliser un joueur à tort.
